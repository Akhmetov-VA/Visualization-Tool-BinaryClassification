...
def main():
    ...
    params = {
        'X': X, 'y': y, 'clf_separator': LogisticRegression(), 'data_dir_path': 'data',
        'balance_method': 'undersample_centroid', 'sampling_strategy': 0.5, 'num_points_per_dim':4,
        'save_rotate_gif': True, 'save_2d_img': True, 'elev': 10, 'seed': 47, 'n_neighbors': 10,
        'dim_red_method_name': 'all'
    }

    dim_red_tool = DimRedTool(X=X, y=y, clf_separator=LogisticRegression(), data_dir_path='data', )
